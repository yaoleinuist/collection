...
public class HttpUtil {
    ...
    public  Map<String,String> getParamsMapByData(String  data){
    ...
    public static void main(String[] args) {
    	...
    	String jsonStr=doGet("http://localhost/uploadFile/rest/file/get/995",params,"UTF-8");
