...
public class RedisConstant {
     ...
     * 会员卡详情信息
     */
    public static final String WEMALL_MEMBER_CARD_DETAIL_KEY = PREFIX + "vipCard:%s";

    public static final String WEMALL_MEMBER_USER_INFO_CARD_KEY = PREFIX + "memberInfo:cardId:%s";

    /**
     * 用户会员卡集合信息
     */
    public static final String WEMALL_USER_VIP_CARD_KEY = PREFIX + "userVipCard:userId:%s:businessId:%d";
    
    /**
     * 集团会员中心信息
     */
    public static final String WEMALL_MEMBER_CENTER_BUSSINESS_KEY = PREFIX + "vipCenter:%s:businessId:%s";

    /**
     * 子wemall id 转换为集团商户id缓存
     */
    public static final String WEMALL_BUSINESSID_MERCHANTID = PREFIX + "businessId:MerchantId:%ds";

    /**
     * 子wemall id 转换为 主wemall ID
     */
    public static final String WEMALL_BUSINESSID_ACCOUNTID = PREFIX + "businessId:AccountID:%ds";
    
    /**
     * wemall会员等级详情信息
     */
    public static final String WEMALL_MEMBER_CARD_LEVEL_ACCOUNT_KEY = PREFIX + "memberCardLevel:%s:accountId:%s";

    /**
     * wemall会员等级扩展信息
     */
    public static final String WEMALL_MEMBER_CARD_LEVEL_EXTENSION_KEY = PREFIX + "wemallLevelExtension:levelId:%s:accountId:%s";

    /**
     * 会员规则详情信息
     */
    public static final String WEMALL_MEMBER_CARD_RULE_DETAIL_KEY = PREFIX + "memberCardRule:%s";

    /**
     * 会员卡等级下的会员规则
     */
    public static final String WEMALL_MEMBER_LEVEL_CARD_RULE_KEY = PREFIX + "memberCardRule:levelId:%s";

    /**
     * 会员卡等级下对应某个会员规则
     */
    public static final String WEMALL_MEMBER_LEVEL_CARD_RULE_DETAIL_KEY = PREFIX + "memberCardRule:levelId:%s:ruleId:%s";

    /**
     * 会员等级
     */
    public static final String WEMALL_MEMBER_CARD_RULE_LEVEL_KEY = PREFIX + "memberCardRule:level:%s";

    /**
     * 会员订单缓存
     */
    public static final String WEMALL_ORDER_EXTENTSION = PREFIX + "wemallOrderExtension:%s";

    /**
     * 会员订单商品缓存
     */
    public static final String WEMALL_ORDER_COUPON_EXTENTSION = PREFIX + "wemallOrderCOUPONExtension:%s";

    /**
     * 会员体系开关
     */
    public static final String WEMALL_NAVIGATE_CONFIG = PREFIX + "moduleConfig:wemallGroupId:%s:module:%s";

    /**
     * 会员升级规则开关
     */
    public static final String WEMALL_UPGRADE_RULE_CONFIG = PREFIX + "member:upgrade:config:%s";

    /**
     * 是否已经充话费、流量标识 核销码为key
     */
    public static final String AUTO_RECHARGE = PREFIX + "couponDiscountCode:%s";

    /**
     * 商场优选活动电子券
     */
    public static final String WEMALL_SHOPPING_MALL_OPTIMIZATION_COUPON = PREFIX + "shoppingMallOptimizationCoupon";

    /**
     * 用户下单校验
     */
    public static final String LOCK_USER_COUPON = PREFIX + "lockUserCoupon:userId:%s:couponId:%d";
